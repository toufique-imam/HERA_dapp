...
const NextDrawCard = () => {
  ...
  const { endTime, amountCollectedInDefi, userTickets, status } = currentRound
  ...
  const prizeInBusd = amountCollectedInDefi.times(cakePriceBusd)
      ...
      <>
        ...
        {prizeInBusd.isNaN() ? (
          ...
          <Balance
            ...
            textAlign={['center', null, null, 'left']}
            unit=" DEFI"
            value={getBalanceNumber(amountCollectedInDefi)}
            decimals={0}
          />
        )}
      </>
