...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and DEFI pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and DEFI pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from DEFI pool', data)
  }
